...
Plan hub and land on the risk/preferences setup surface).
...
- Flow layer: 9 of 12 Tasks done (view net worth, add account, add
  transaction entry, import statement drafts, rebalance, options income,
  FIRE report, export backup, navigate primaries); grow toward the remaining
  Tasks in §3 (AI, portfolio analysis, backup restore).
