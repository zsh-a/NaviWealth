...
- FinanceOS Weekly Wealth Review 的 deterministic artifact fixture 已接入 `no_llm_profile` corpus case，锁住 Finance agent 在无 LLM profile 时仍可产出本地计算结果的 fallback 契约。
