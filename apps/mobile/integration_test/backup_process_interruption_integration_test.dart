...
void main() {
  ...
  testWidgets('interrupt restore after the destructive wipe begins', (_) async {
    ...
    final payload = jsonDecode(utf8.decode(plaintext)) as Map<String, Object?>;
  ...
  testWidgets('fresh process observes rollback after interrupted restore', (
    _,
  ) async {
    ...
    debugPrint('backup: interruption verification preserved account + outbox');
