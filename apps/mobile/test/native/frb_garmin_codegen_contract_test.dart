...
const _agentRuntimeFacadeSymbols = <String>[
  ...
  'agentRuntimeStartRunSnapshot',
  'agentRuntimeContinueRunSnapshot',
  'agentRuntimeCancelRunSnapshot',
  'agentRuntimeValidateLlmRequest',
  'agentRuntimeValidateLlmResponse',
  'agentRuntimeCompleteMockLlm',
  'agentRuntimeCompleteProfileLlm',
...
const _dartGeneratedApiSymbols = <String>[
  ...
  'crateApiAgentRuntimeAgentRuntimeStartRunSnapshot',
  'crateApiAgentRuntimeAgentRuntimeContinueRunSnapshot',
  'crateApiAgentRuntimeAgentRuntimeCancelRunSnapshot',
  'crateApiAgentRuntimeAgentRuntimeValidateLlmRequest',
  'crateApiAgentRuntimeAgentRuntimeValidateLlmResponse',
  'crateApiAgentRuntimeAgentRuntimeCompleteMockLlm',
  'crateApiAgentRuntimeAgentRuntimeCompleteProfileLlm',
...
const _rustGeneratedSymbols = <String>[
  ...
  'wire__crate__api__agent_runtime__agent_runtime_start_run_snapshot_impl',
  'wire__crate__api__agent_runtime__agent_runtime_continue_run_snapshot_impl',
  'wire__crate__api__agent_runtime__agent_runtime_cancel_run_snapshot_impl',
  'wire__crate__api__agent_runtime__agent_runtime_validate_llm_request_impl',
  'wire__crate__api__agent_runtime__agent_runtime_validate_llm_response_impl',
  'wire__crate__api__agent_runtime__agent_runtime_complete_mock_llm_impl',
  'wire__crate__api__agent_runtime__agent_runtime_complete_profile_llm_impl',
