...
void main() {
  ...
  // FIR-67 propose-card 60s undo: a single soft-delete must tombstone
  // exactly the targeted row + queue one delete op for sync.
  group('softDeleteById', () {
    test('soft-deletes the row and queues one delete op', () async {
      final tx = Transaction(
        id: 'cash-1',
        accountId: 'acct-1',
        assetId: null,
