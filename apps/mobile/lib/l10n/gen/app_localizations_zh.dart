...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get wealthActionPanelAccountsAndLiabilitiesGroup => '账户与负债';
  ...
  String get aiTraceNoPayloadCaptured =>
      '此步骤没有输入输出记录。可能未启用详细采集，或该执行路径未提供数据。详细采集仅对开启后新发起的调用生效，历史记录无法补采。';
  ...
  @override
  String get settingsDomainsExecutionEnabledSubtitle => '今日行动、计划与复盘';

  @override
  String get settingsDomainsExecutionDisabledSubtitle => '把决策与计划转成可追踪的行动';

  @override
  String get settingsDomainsExecutionTodaySubtitle => '查看今天的行动、阻塞与更新';
  ...
  @override
  String get executionEditProgressTitle => '编辑更新';
  ...
  @override
  String get executionProgressKindField => '更新类型';

  @override
  String get executionProgressNoteField => '更新记录';

  @override
  String get executionProgressNoteHint => '记录变化或备注；如需改变行动状态，请使用行动操作。';

  @override
  String get executionProgressNoteRequired => '请填写更新';
  ...
  @override
  String get executionReviewProgressMetric => '更新';

  @override
  String get executionReviewGenerateTitle => '执行复盘';

  @override
  String get executionReviewGenerateBody => '在本地生成焦点、阻塞、到期事项和近期更新摘要。';
  ...
  @override
  String get executionAgentReviewInsightProgressTitle => '每周更新';
  ...
  String get executionReviewCreateNextActionsBody =>
      '是否为仍缺少下一步行动的每个计划或持续计划创建一个高优先级行动？';
  ...
  @override
  String get agentExecutionTitle => '执行过程';

  @override
  String get agentExecutionView => '查看执行过程';

  @override
  String get agentExecutionDiagnostics => '技术详情';

  @override
  String get agentExecutionModel => '模型';

  @override
  String get agentExecutionStop => '停止执行';

  @override
  String get agentExecutionHint => '离开此页面不会停止任务。移动端进入后台可能中断执行，可返回后手动重试。';

  @override
  String get agentExecutionMissing => '暂无详细执行记录。旧版运行记录仍保留在历史中。';
  ...
  String agentExecutionError(String code) {
    String _temp0 = intl.Intl.selectLogic(code, {
      'model_unavailable': '请先配置模型，再运行此任务。',
      'no_tools': '当前领域没有可用的只读工具。',
      'scheduled_task_timeout': '执行已达到时限，请检查工具步骤及模型连接后重试。',
      'tool_timeout': '工具执行超时。',
      'invalid_report': '模型未返回有效且有证据支持的报告。',
      'scheduled_task_user_cancelled': '你已停止本次执行。',
      'scheduled_task_backgrounded': '应用离开前台，本次执行已中断。',
      'scheduled_task_interrupted': '上次执行已中断，不会自动重新运行。',
      'scheduled_task_access_revoked': '账号或领域访问权限已变化。',
      'scheduled_task_disabled': '此任务已停用。',
      'scheduled_task_changed': '执行过程中任务配置已变化。',
      'other': '本次执行未完成，请检查模型连接和执行详情后重试。',
    });
    return '$_temp0';
  }
}
