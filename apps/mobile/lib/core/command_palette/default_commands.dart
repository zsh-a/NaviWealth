...
List<CommandPaletteEntry> defaultCommandPaletteEntries(
  ...
  return <CommandPaletteEntry>[
    ...
    CommandPaletteEntry(
      ...
      keywords: const <String>[AppRoutes.activityAccounts, 'accounts', '账户'],
    ...
    CommandPaletteEntry(
      ...
      keywords: const <String>[AppRoutes.planAnalytics, 'analytics', '分析'],
    ...
    CommandPaletteEntry(
      ...
      icon: Icons.flag_outlined,
      keywords: const <String>[AppRoutes.planFire, 'fire'],
