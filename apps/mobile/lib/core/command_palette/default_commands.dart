...
List<CommandPaletteEntry> defaultCommandPaletteEntries(
  ...
  return <CommandPaletteEntry>[
    ...
    CommandPaletteEntry(
      ...
      run: (BuildContext ctx) => ctx.go(AppRoutes.ai),
    ),
    CommandPaletteEntry(
      id: 'nav.accounts',
    ...
    CommandPaletteEntry(
      ...
      keywords: const <String>[AppRoutes.aiInsightsAnalytics, 'analytics', '分析'],
      run: (BuildContext ctx) => ctx.go(AppRoutes.aiInsightsAnalytics),
    ),
    CommandPaletteEntry(
      id: 'nav.fire',
      label: l10n.planFireTitle,
      icon: Icons.flag_outlined,
      keywords: const <String>[AppRoutes.aiInsightsFire, 'fire'],
      run: (BuildContext ctx) => ctx.go(AppRoutes.aiInsightsFire),
    ),
    CommandPaletteEntry(
      id: 'nav.settings',
    ...
    CommandPaletteEntry(
      ...
      keywords: const <String>[AppRoutes.ai, 'ai', 'assistant', '助手'],
