  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: Spacing.s12),
        _CategoryListCard(report: report, categoryById: expenseAccountById),
      ],
    );
  }
}
...
class _CategoryPieCard extends StatelessWidget {
  const _CategoryPieCard({required this.report, required this.categoryById});
...
class _CategoryListCard extends StatelessWidget {
  const _CategoryListCard({required this.report, required this.categoryById});
