...
part 'tool_invocation_renderers_asset_allocation.dart';
part 'tool_invocation_renderers_analytical_lists.dart';
part 'tool_invocation_renderers_holdings.dart';
part 'tool_invocation_renderers_performance.dart';
part 'tool_invocation_renderers_breakdowns.dart';
