...
mixin _$Currency {
 ...
 String get code; String get name; int get decimals; String? get symbol;
...
@useResult
$Res call({
 String code, String name, int decimals, String? symbol
});
...
/// Create a copy of Currency
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? name = null,Object? decimals = null,Object? symbol = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String name,  int decimals,  String? symbol)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Currency() when $default != null:
return $default(_that.code,_that.name,_that.decimals,_that.symbol);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String name,  int decimals,  String? symbol)  $default,) {final _that = this;
switch (_that) {
case _Currency():
return $default(_that.code,_that.name,_that.decimals,_that.symbol);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  String name,  int decimals,  String? symbol)?  $default,) {final _that = this;
switch (_that) {
case _Currency() when $default != null:
return $default(_that.code,_that.name,_that.decimals,_that.symbol);case _:
  return null;
...
class _Currency implements Currency {
  const _Currency({required this.code, required this.name, required this.decimals, this.symbol});
...
/// Create a copy of Currency
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = null,Object? name = null,Object? decimals = null,Object? symbol = freezed,}) {
