...
class _JournalEntry implements JournalEntry {
  const _JournalEntry({required this.id, required this.date, this.settledOn, required this.narration, this.payee, final  List<String> tagIds = const <String>[], this.flag = EntryFlag.confirmed, required this.sync}): _tagIds = tagIds;
