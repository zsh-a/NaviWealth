...
final securitiesCatalogLoaderProvider =
    FutureProvider<SecuritiesCatalogLoader>((ref) async {
...
final securitiesSearchServiceProvider =
    FutureProvider<SecuritiesSearchService>((ref) async {
