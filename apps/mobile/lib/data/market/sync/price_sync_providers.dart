...
/// resolves.
final priceSyncCoordinatorProvider =
    FutureProvider<PriceSyncCoordinator>((ref) async {
      ...
      final coordinator = PriceSyncCoordinator(
        ...
        writeDailySnapshots: () =>
            ref.read(writeDailyPriceSnapshotsProvider),
        clock: clock,
...
final priceSyncCoordinatorBootstrapProvider = Provider<void>((ref) {
  ref.listen<AsyncValue<PriceSyncCoordinator>>(
    priceSyncCoordinatorProvider,
    (_, next) {
