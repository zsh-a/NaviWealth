...
struct RuntimeProfile {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    eval_store: Option<Utf8PathBuf>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    registry: Option<Utf8PathBuf>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    catalog: Option<Utf8PathBuf>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    tool_sources: Option<Vec<Utf8PathBuf>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    host: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    port: Option<u16>,
...
fn configured_u64(value: u64, default: u64, configured: Option<u64>) -> u64 {
    if value == default {
...
fn configured_u32(value: u32, default: u32, configured: Option<u32>) -> u32 {
    if value == default {
        configured.unwrap_or(value)
    } else {
        value
...
fn configured_u16(value: u16, default: u16, configured: Option<u16>) -> u16 {
    if value == default {
        configured.unwrap_or(value)
    } else {
        value
...
fn configured_string(value: String, default: &str, configured: Option<&String>) -> String {
    if value == default {
        configured.cloned().unwrap_or(value)
    } else {
        value
