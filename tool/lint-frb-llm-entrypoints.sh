...
ALLOWLIST_REGEX='apps/mobile/lib/core/ai/runtime/|apps/mobile/lib/core/ai/llm_credentials/(llm_connectivity|providers)\.dart|apps/mobile/lib/features/ingest/data/device_ingest_client\.dart|apps/mobile/lib/features/health/agents/briefing_synthesizer\.dart|apps/mobile/lib/features/knowledge/data/llm_(capture_classifier|contradiction_judge|inbox_triage_classifier)\.dart'
